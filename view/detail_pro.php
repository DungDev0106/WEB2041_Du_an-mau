        ...
        <div class="content w-5/6 mt-10 mx-auto grid grid-cols-[50%50%]">
            ...
            <div class="detail_pro text-gray-700">
                <p class="text-[19px] text-gray-500">
                    ...
                    <a href="index.php?act=list_product&cate_id=<?php foreach($list_cate as $cate){echo ($cate['cate_id']==$detail_pro['cate_id'])?$cate['cate_id']:"";}?>" class="hover:text-black uppercase">
                ...
                <div class="text-[21px] space-y-4 ">
                    <p class="font-[500] text-red-500"><?php echo $detail_pro['pro_price']?><u>đ</u></p>
                    ...
                    <p><span class="font-[500]">Cam kết:</span> Chúng tôi sẽ hoàn tiền nếu túi không phải là da và không giống như hình chụp</p>
                    <p><span class="font-[500]">Mô tả:</span> <?php echo $detail_pro['pro_desc']?></p>
                    <p class="text-xl text-gray-500">Hình ảnh sản phẩm 100% chụp bằng sản phẩm thật, do ánh sáng môi trường xung quanh và màn hình hiển thị độ phân giải là lý do khiến màu của ví đậm hơn hoặc nhạt hơn so với bên ngoài.</p>
                </div>
